...
sentencia returns[Sentencia ast]
	...
	| ex1=expresion '=' ex2=expresion ';' { $ast = new Asignacion($ex1.ast, $ex2.ast); }
...
expresion returns[Expresion ast]
	...
	| ex1=expresion '?' ex2=expresion ':' ex3=expresion { $ast = new OperadorTernario($ex1.ast, $ex2.ast, $ex3.ast);}
	;
