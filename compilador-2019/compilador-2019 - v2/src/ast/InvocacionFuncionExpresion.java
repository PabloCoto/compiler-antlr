...
public class InvocacionFuncionExpresion extends AbstractExpresion {

	public InvocacionFuncionExpresion(String id, List<Expresion> parametros) {
		this.id = id;
	...
	public InvocacionFuncionExpresion(Object id, Object parametros) {
